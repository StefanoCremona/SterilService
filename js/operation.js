...
function saveInstruments(trayId, instTypeId, instNumber) {
    if (!instNumber) {
        alert('Fill the intrument number, Please!');
        return;    
    }
    ...
    xmlhttp.open("POST", "./json/saveTraySet.php", true);
    xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xmlhttp.send("trayId="+trayId+"&instTypeId="+instTypeId+"&instNumber="+instNumber);
}
